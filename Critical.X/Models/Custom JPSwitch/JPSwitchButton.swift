...
public class JPSwitchButton: UIView {
    ...
    let kLabelFontSizeSmall: CGFloat = 10.0
    let kLabelFontSizeLarge: CGFloat = 15.0
    ...
    var shortText: String? {
        didSet {
            ...
            shortDescriptionLabel?.font = shortText.count > 7 ? UIFont(name: "Futura", size: kLabelFontSizeSmall) : UIFont(name: "Futura", size: kLabelFontSizeLarge)
