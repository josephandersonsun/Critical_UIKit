...
class VAD_CollectionViewCell: UICollectionViewCell {
    
    @IBOutlet weak var vad_CellLabel: UILabel!
    
    @IBOutlet weak var vad_Detail_CellLabel: UILabel!
