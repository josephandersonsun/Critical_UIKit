//
//  UltraSound_CollectionViewCell.swift
//  Critical.X
//
...
class UltraSound_CollectionViewCell: UICollectionViewCell {
    
    @IBOutlet weak var USMain_CellLabel: UILabel!
    
    @IBOutlet weak var USDetail_CellLabel: UILabel!
