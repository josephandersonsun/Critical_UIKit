...
class OBCollectionCell: UICollectionViewCell {
    
    @IBOutlet weak var OBMain_CellLabel: UILabel!
    
    @IBOutlet weak var OBDetail_CellLabel: UILabel!
