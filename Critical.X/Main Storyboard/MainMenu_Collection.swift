...
//        label = LTMorphingLabel(frame: CGRect(x: 8, y: 175, width: 359, height: 29))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let randomNavBarColors = [ #colorLiteral(red: 0.8156862745, green: 0.2549019608, blue: 0.2549019608, alpha: 1) , #colorLiteral(red: 0.2039999962, green: 0.2860000134, blue: 0.3689999878, alpha: 1), #colorLiteral(red: 0.05098039216, green: 0.1019607843, blue: 0.1411764706, alpha: 1), #colorLiteral(red: 0.9358316064, green: 0.3514818549, blue: 0.1909768581, alpha: 1)]
